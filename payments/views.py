...
import logging
from payments.utils import get_access_token,query_mpesa_payment_status
from payments.models import Payment
from django.utils import timezone


mpesa_token = settings.MPESA_ACCESS_TOKEN_URL
    ...
    if request.method == 'POST':
        try:
            ...
            payload = {
                ...
                "TransactionDesc": "Payment for Buildmart"
            }
...
def payment_details_view(request, order_id):
    ...
    Retrieves payment details for a specific order using the order ID.
    """
    try:
...
def mpesa_callback(request):
    if request.method == 'POST':
        try:
            ...
            # Find the payment record based on CheckoutRequestID  
